...
import 'package:honeyaa_clientside/chat/Message.dart';
import 'package:random_string/random_string.dart';

class ChatScreen extends StatefulWidget {
  final String chatWithUsername, name, uid;
  ChatScreen(this.chatWithUsername, this.name, this.uid);
  @override
                ...
                child: Row(
                  children: [
                    Expanded(
                      ...
                      onChanged: (value) {
                        if(messageTextEdittingController.text.isEmpty)
                          {addMessage(false);}
                      },
                      style: TextStyle(color: Colors.white),
